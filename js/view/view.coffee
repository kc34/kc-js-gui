...
class @View extends @CanvasPanel
  ...
  constructor: (model) ->
    ...
    @exampleMainScreen = new (class extends Panel
      ...
      constructor: (x, y, width, height) ->
        ...
        @exampleSideMenu = new (class extends Panel
          ...
          preprocess: ->
            this.exampleButton.setWindow(this.width * 0.1, this.width * 0.1, this.width * 0.8, this.width * 0.8)

          buttonClickEvent: ->
            this.parentComponent.buttonClickEvent()
        )(0, 100, 100, window.innerHeight)
        this.addComponent(@exampleSideMenu)
        ...
        this.addComponent(@exampleCanvas)
        ...
        this.addComponent(@examplePopup)
        instance = this
    ...
    this.addComponent(@exampleMainScreen)
